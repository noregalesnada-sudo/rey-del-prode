...
const prizes = [
  { label: "Samsung No-Frost Refrigerator", pos: 1 },
  { label: 'LG 50" 4K Smart TV',            pos: 2 },
  { label: "Sony Sound System",              pos: 3 },
];
...
const featureBadges = [
  ...
  { icon: "🔒", text: "Locks 15 min before kickoff" },
  { icon: "✏️", text: "Autosave picks" },
];

const areas = [
  { name: "Sales",       members: 14, total: 462, avg: 33.0 },
  { name: "Technology",  members: 11, total: 341, avg: 31.0 },
  { name: "Operations",  members: 15, total: 435, avg: 29.0 },
  { name: "HR",          members:  8, total: 208, avg: 26.0 },
];
...
export const SceneLeaderboardPremiosEN: React.FC = () => {
        ...
        <div style={{ flex: "0 0 58%", display: "flex", flexDirection: "column", gap: 0 }}>
          <div style={{
            ...
            <div style={{ background: CARD_HDR_BG, borderBottom: `1px solid ${BORDER}`, padding: "12px 20px", display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 16, height: 16, borderRadius: 3, background: "#f59e0b", flexShrink: 0 }} />
              <span style={{ fontFamily: roboto, fontSize: 14, fontWeight: 700, color: "#cbd5e1", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                Overall Ranking — NEXO Football Pool
              </span>
            </div>
            <div style={{ display: "flex", alignItems: "center", padding: "8px 20px", borderBottom: `1px solid ${BORDER}` }}>
              ...
              <div style={{ width: 150, fontFamily: roboto, fontSize: 11, fontWeight: 700, color: "#475569", textTransform: "uppercase", letterSpacing: "0.06em" }}>Progress</div>
          ...
          <div style={{ opacity: copyTopP, transform: `scale(${interpolate(copyTopP, [0, 1], [0.93, 1])})`, marginTop: 16, textAlign: "center" }}>
            <div style={{ fontFamily: barlowCondensed, fontSize: 52, fontWeight: 900, color: "#ffffff", lineHeight: 0.95, textTransform: "uppercase", whiteSpace: "nowrap" }}>
              Your team competes.{" "}
              <span style={{ color: "#FFD700" }}>You choose the prizes.</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div style={{ flex: "0 0 46%" }}>
            <div style={{ opacity: titleP, marginBottom: 14 }}>
              <div style={{ fontFamily: barlowCondensed, fontSize: 44, fontWeight: 900, color: "#ffffff", lineHeight: 0.9, textTransform: "uppercase", textAlign: "center" as const }}>
                Ranking by <span style={{ color: CELESTE }}>department</span>
              </div>
            </div>
            ...
            <div style={{ background: CARD_BG, borderRadius: 12, border: `1px solid ${BORDER}`, overflow: "hidden" }}>
              <div style={{ display: "flex", alignItems: "center", padding: "8px 16px", borderBottom: `1px solid ${BORDER}`, background: CARD_HDR_BG }}>
                <div style={{ width: 32 }} />
                <div style={{ flex: 1, fontFamily: roboto, fontSize: 11, fontWeight: 700, color: "#475569", textTransform: "uppercase", letterSpacing: "0.06em" }}>Area</div>
                <div style={{ width: 70, textAlign: "right" as const, fontFamily: roboto, fontSize: 11, fontWeight: 700, color: "#475569", textTransform: "uppercase", letterSpacing: "0.06em" }}>Members</div>
                ...
                <div style={{ width: 72, textAlign: "right" as const, fontFamily: roboto, fontSize: 11, fontWeight: 700, color: "#475569", textTransform: "uppercase", letterSpacing: "0.06em" }}>Avg.</div>
              </div>
              {areas.map((a, i) => {
                const rp = areaRowP(i);
                ...
                return (
                  <div key={a.name} style={{
                    ...
                    <div style={{ width: 70, textAlign: "right" as const, fontFamily: roboto, fontSize: 13, color: "#475569" }}>{a.members}</div>
            ...
            <div style={{ opacity: eyebrowP, marginTop: 12 }}>
              <div style={{ fontFamily: roboto, fontSize: 28, fontWeight: 600, color: CELESTE, letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Team competition across departments
              </div>
            </div>
          </div>

          {/* Right: internal ranking */}
          <div style={{ flex: "0 0 50%", opacity: transP }}>
            <div style={{ opacity: innerHdrP, marginBottom: 14 }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(245,158,11,0.12)", border: "1px solid rgba(245,158,11,0.3)", borderRadius: 8, padding: "4px 12px" }}>
                ...
                <span style={{ fontFamily: roboto, fontSize: 15, fontWeight: 700, color: "#f59e0b" }}>Sales</span>
                <span style={{ fontFamily: roboto, fontSize: 13, color: "#475569" }}>· 14 players</span>
              </div>
            </div>
            ...
            {/* Copy aligned with internal ranking */}
            <div style={{
              opacity: copyBotP,
              ...
              <div style={{
                ...
                Internal ranking{" "}
                <span style={{ color: CELESTE }}>per department.</span>
              </div>
            </div>
          </div>
        </div>

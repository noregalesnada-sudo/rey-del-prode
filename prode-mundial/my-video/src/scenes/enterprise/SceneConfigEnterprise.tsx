...
const ACTIVE_TAB = "CONFIGURACIÓN";

export const SceneConfigEnterprise: React.FC = () => {
          ...
          <div style={{ flex: "0 0 55%", display: "flex", flexDirection: "column", gap: 20, overflowY: "auto" }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                Prode NEXO — Mundial 2026
              </div>
              <div style={{ fontFamily: roboto, fontSize: 11, color: "#475569", marginTop: 5 }}>
                Si está vacío, se usa el nombre por defecto.
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: 24 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontFamily: roboto, fontSize: 12, color: "#9ab3d1", marginBottom: 8 }}>Color primario</div>
                ...
                <div style={{
                  ...
                  <div style={{ fontFamily: roboto, fontSize: 12, color: "#9ab3d1", marginBottom: 8 }}>Color secundario</div>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <div style={{
                      width: 32,
                      height: 32,
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                ...
                <div style={{
                  ...
                  {logoP > 0.3 ? (
                    ...
                    <div style={{ fontFamily: roboto, fontSize: 11, color: "#475569" }}>Sin logo</div>
                  )}
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  ...
                  <div style={{ fontFamily: roboto, fontSize: 11, color: "#475569" }}>Formato: PNG, máx 5MB</div>
                </div>
              </div>
            </div>

            {/* Sección: Banner del prode */}
            <div style={{
              opacity: secP(3),
        ...
        {overlayP > 0 && (
          <div style={{
            ...
            <div style={{
              ...
              Tu marca.{" "}
              <span style={{ color: GOLD }}>Tu logo.</span>
              {" "}Tus colores.
            </div>
          </div>
        )}

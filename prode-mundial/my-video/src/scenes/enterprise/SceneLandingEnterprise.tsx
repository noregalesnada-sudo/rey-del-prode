...
const bullets = [
  "Tu logo y banner propios",
  "Tus colores de marca",
  "Acceso exclusivo para empleados",
];

export const SceneLandingEnterprise: React.FC = () => {
        ...
        <div style={{ flex: "0 0 28%", display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          <div style={{ opacity: titleP, transform: `translateY(${titleY}px)` }}>
            <div style={{
              ...
              Con tu<br />
              <span style={{ color: CELESTE }}>marca</span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                Accedé con tu cuenta de empleado
              </div>

      ...
      <AbsoluteFill style={{ display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"center", gap:60, padding:"0 140px" }}>
        ...
        <div style={{ opacity:labelP, transform:`translateY(${labelY}px)`, display:"flex", flexDirection:"column", gap:24 }}>
          ...
          <div style={{ opacity:exP }}>
            <div style={{ fontFamily:roboto, fontSize:34, fontStyle:"italic", color:"rgba(116,172,223,0.6)", background:"rgba(116,172,223,0.06)", border:"1px solid rgba(116,172,223,0.18)", borderRadius:12, padding:"12px 28px", display:"inline-block" }}>Predicted 3-1 · Result 2-0 · same diff +2</div>
          </div>
        </div>
      </AbsoluteFill>
    </AbsoluteFill>

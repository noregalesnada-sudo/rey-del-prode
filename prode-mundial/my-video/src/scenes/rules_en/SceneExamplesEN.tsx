  ...
  return (
    <AbsoluteFill style={{ background: "#071428", overflow: "hidden" }}>
      ...
      <AbsoluteFill style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 36, padding: "0 60px" }}>
        ...
        <div style={{ opacity: titleP, textAlign: "center", width: "100%" }}>
          <div style={{ fontFamily: barlowCondensed, fontWeight: 900, fontSize: 72, textTransform: "uppercase", letterSpacing: 5, color: "#74ACDF" }}>
            Scoring Examples
          </div>
        ...
        <div style={{
          ...
          border: "1.5px solid rgba(255,215,0,0.25)", borderRadius: 18,
          display: "flex", alignItems: "center", gap: 28, padding: "32px 36px",
        }}>
          <div style={{
            ...
            fontFamily: barlowCondensed, fontWeight: 900, fontSize: 64, color: "#FFD700",
          }}>3</div>
          <div>
            <div style={{ fontFamily: roboto, fontWeight: 700, fontSize: 40, color: "#fff", marginBottom: 10 }}>
              Exact Score
            </div>
            <div style={{ fontFamily: roboto, fontSize: 34, color: "rgba(255,255,255,0.55)", lineHeight: 1.45 }}>
              Predicted <strong style={{ color: "rgba(255,215,0,0.8)" }}>England 2–1 Germany</strong>
        ...
        <div style={{
          ...
          border: "1.5px solid rgba(116,172,223,0.25)", borderRadius: 18,
          display: "flex", alignItems: "center", gap: 28, padding: "32px 36px",
        }}>
          <div style={{
            width: 100, height: 100, borderRadius: 16, flexShrink: 0,
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            fontFamily: barlowCondensed, fontWeight: 900, fontSize: 64, color: "#74ACDF",
          }}>2</div>
          <div>
            <div style={{ fontFamily: roboto, fontWeight: 700, fontSize: 40, color: "#fff", marginBottom: 10 }}>
              Winner + Goal Diff
            ...
            <div style={{ fontFamily: roboto, fontSize: 34, color: "rgba(255,255,255,0.55)", lineHeight: 1.45 }}>
              Predicted <strong style={{ color: "rgba(116,172,223,0.8)" }}>3–1</strong>, result <strong style={{ color: "#fff" }}>2–0</strong>
              <br /><span style={{ color: "rgba(116,172,223,0.6)" }}>Same goal diff (+2) → 2 pts</span>
            </div>
          </div>
        </div>

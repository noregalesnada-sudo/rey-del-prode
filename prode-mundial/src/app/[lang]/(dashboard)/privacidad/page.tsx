    ...
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '40px 0 80px' }}>
      ...
      <Section title="2. Datos que Recopilamos">
        ...
        <p>
          ...
          operativo y datos de uso anónimos con el fin de mejorar el rendimiento de la aplicación.
        </p>
      </Section>
      ...
      <Section title="4. Visibilidad dentro de la Aplicación">
        ...
        <p>El nombre de usuario y la foto de perfil (si la cargaste) son visibles para los demás miembros de los prodes en los que participás.</p>
        <p>Los pronósticos por defecto (fuera de un prode privado) son completamente privados.</p>
      </Section>

      <Section title="5. Almacenamiento y Seguridad">
        <p>
          Los datos son almacenados en servidores seguros provistos por Supabase, con cifrado en tránsito (HTTPS/TLS) y en reposo.
        </p>
        <p>Las fotos de perfil se almacenan en un bucket de almacenamiento seguro con acceso controlado.</p>
      </Section>

      <Section title="6. Retención de Datos">
        <p>
          Los datos del usuario se conservan mientras la cuenta esté activa. El usuario puede solicitar la
          eliminación de su cuenta enviando un correo a contacto@reydelprode.com. La eliminación se procesará dentro de los 30 días hábiles.
        </p>
      </Section>

      <Section title="7. Derechos del Usuario">
        <p>De acuerdo con la Ley N° 25.326, el usuario tiene derecho a acceder, rectificar, suprimir y oponerse al tratamiento de sus datos.</p>
      ...
      <Section title="8. Cookies y Tecnologías Similares">
        <p>
          La aplicación utiliza cookies exclusivamente para mantener la sesión del usuario activa.
          No utilizamos cookies con fines publicitarios ni de seguimiento de terceros.
        </p>
      </Section>

      <Section title="9. Menores de Edad">
        <p>
          Rey del Prode no está dirigida a menores de 13 años.
        </p>
      </Section>

      <Section title="10. Cambios en esta Política">
        <p>
          Podemos actualizar esta Política periódicamente. Te notificaremos por correo o mediante un aviso en la aplicación ante cambios significativos.
        </p>
      </Section>

      <Section title="11. Contacto" last>
        <p>
          Para cualquier consulta relacionada con esta Política, podés contactarnos en: contacto@reydelprode.com
        </p>
